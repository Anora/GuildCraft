...
public class GcWorldGen implements IWorldGenerator
{
			...
			IChunkProvider chunkProvider)
	{
		...
		//Overworld
			//Ores
			this.runGenerator(this.oreAluminum, world, random, chunkX, chunkX, 10, 0, 100);
			this.runGenerator(this.oreCopper, world, random, chunkX, chunkX, 20, 0, 225);
			this.runGenerator(this.oreDragonite, world, random, chunkX, chunkX, 8, 3, 16);
			this.runGenerator(this.oreMythirll, world, random, chunkX, chunkX, 10, 4, 15);
			this.runGenerator(this.oreOrichalcum, world, random, chunkX, chunkX, 7, 3, 10);
			this.runGenerator(this.orePlatnum, world, random, chunkX, chunkX, 10, 0, 45);
			this.runGenerator(this.oreSilver, world, random, chunkX, chunkX, 10, 4, 20);
			this.runGenerator(this.oreTin, world, random, chunkX, chunkX, 20, 0, 75);
